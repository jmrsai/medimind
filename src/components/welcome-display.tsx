  ...
  return (
    <Card className="h-full border-2 border-dashed shadow-none">
      ...
      <CardContent className="flex flex-col items-center justify-center text-center h-full space-y-6 p-10">
        ...
        <h2 className="text-xl font-semibold">AI-Powered Diagnosis Support</h2>
        <p className="text-muted-foreground max-w-md">
          To get started, paste your patient's report data into the text area on the left and click "Analyze Data". Our AI will provide a potential diagnosis, supporting evidence, and treatment suggestions.
        </p>
